                ...
                <table id="file" class="table striped">
                  <thead>
                      <tr>
                        ...
                        <td style="color:#fff;"><strong>ID User</strong></td>
                    ...
                    <tbody>
                    <?php
                        $query2 = mysqli_query($sambungan, "SELECT * FROM keluhan WHERE status_keluhan='Telah ditanggapi'")
                        or die(mysqli_error($sambungan));
                        while($data = mysqli_fetch_array($query2)){
                          $id_keluhan = $data['id_keluhan'];
                          $query3 = mysqli_query($sambungan, "SELECT * FROM tanggapan WHERE id_keluhan='$id_keluhan'")
                          or die(mysqli_error($sambungan));
                          $pickid = mysqli_fetch_array($query3);
                          $id_tanggapan = $pickid['id_tanggapan'];
                        ...
                        <tr>
                          ...
                          <td style="color:#fff;"><p style="color:#93bf85;"><?php echo$data['status_keluhan']; ?></p></td>
                          <td><?php echo '<a href="lihat-tanggapan-admin.php?id_tanggapan='.$id_tanggapan.'" class="btn btn-warning">Lihat</a>';?></td>
                        </tr><?php
                        }?>
                  </tbody>
                </table>
