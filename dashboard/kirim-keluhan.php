        ...
        <div class="card">
            ...
            ?>
             ...
             elseif($_GET['pesan'] == "kosong"){
                ...
                Keluhan atau key tidak boleh kosong!
                </div>
            <?php
            }
            else{
                ?>
                <div class="alert alert-danger" role="alert">
                Keluhan gagal terkirim!
                </div>
            <?php
            }
             }
            ?>
            <form class="form-horizontal" method="post" action="proses-keluhan.php" enctype="multipart/form-data">
                      <fieldset>
                        <legend style="color:#fff;">Sampaikan keluhan Anda</legend>
                        <div class="form-group">
                          <label class="col-lg-2 control-label" style="color:#fff;" for="textArea">Deskripsi Keluhan</label>
                          <div class="col-lg-4">
                            <textarea class="form-control" id="textArea" rows="3" name="desc_keluhan"></textarea>
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-lg-2 control-label" style="color:#fff;" for="inputPassword">Key</label>
                          <div class="col-lg-4">
                            <input class="form-control" id="inputPassword" type="password" name="key_keluhan">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-lg-2 control-label" for="textArea"></label>
                          <div class="col-lg-2">
                            <input type="submit" name="kirim_keluhan" value="Kirim keluhan" class="form-control btn btn-info">
                          </div>
                        </div>
                      </fieldset>
                    </form>
