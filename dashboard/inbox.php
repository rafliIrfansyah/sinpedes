                ...
                <table id="file" class="table striped">
                  <thead>
                    ...
                    <?php
                        ...
                        $query = mysqli_query($sambungan, "SELECT * FROM tanggapan WHERE id_user=$id_user AND status_tanggapan='Belum dilihat'")
                        or die(mysqli_error($sambungan));
                        ...
                        <td style="color:#fff;"><?php echo $data['id_tanggapan']; ?></td>
                          ...
                          <td style= "color:#fff; "><?php echo mb_strimwidth($data['deskripsi_tanggapan'],0,30,"...."); ?></td>
                          <td style="color:#fff;"><?php echo $data['tanggal']; ?></td>
                          <td style="color:#fff;"><p style="color:#d41872;"><?php echo$data['status_tanggapan']; ?></p></td>
