                  ...
                  <thead>
                    ...
                    <tbody>
                       <?php
                        ...
                        $query2 = mysqli_query($sambungan, "SELECT * FROM keluhan WHERE id_user='$id_user'")
                        or die(mysqli_error($sambungan));
                        ...
                        <tr>
                          ...
                          <?php 
                            if($data['status_keluhan']=="Telah ditanggapi"){
                              ?><td style="color:#93bf85;"><?php echo $data['status_keluhan']; ?></td> <?php
                            }
                            else{
                              ?><td style="color:#d41872;"><?php echo $data['status_keluhan']; ?></td> <?php
                            }
                          ?>
                        </tr><?php
                        }?>
