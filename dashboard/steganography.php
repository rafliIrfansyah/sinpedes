        ...
        <div class="card">
            ...
            <legend style="color:#d41872;">
              ...
              <div class="form-horizontal">
                      <fieldset>
                        <legend style="color:#fff;">Encoding</legend>
                        <div class="form-group">
                          <label class="col-lg-2 control-label" style="color:#fff;" for="img1">Source Image</label>
                          <div class="col-lg-4">
                            <input type="file" name="img1" accept="image/*" onchange="readURL(this)">
                            <img  id="image1" src="" alt="">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-lg-2 control-label" style="color:#fff;" for="textArea">Pesan Rahasia</label>
                          <div class="col-lg-4">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-lg-2">
                          <input type="button" name="kirim_tanggapan" value="Sembunyikan Pesan" class="form-control btn btn-info" onclick="hideText()">
                          </div>
                        </div>
                        <legend style="color:#fff;">Decoding</legend>
                        <div class="form-group">
                          <label class="col-lg-2 control-label" style="color:#fff;" for="img2">Encoded Image</label>
                          <div class="col-lg-4">
                          <img  id="image2" src="" alt="">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-lg-2 control-label" style="color:#fff;">Source Image</label>
                          <div class="col-lg-4">
                          <input type="file" name="img2" accept="image/*" onchange="decode(this)">
                          </div>
                        </div>
                        <div class="form-group">
                          <label class="col-lg-2 control-label" style="color:#fff;">Decoded Message</label>
                          <div class="col-lg-4">
                          <p id="decoded" style="color:#d41872;"></p>
                          </div>
                        </div>
