              ...
              <div class="table-responsive" style="color:#d41872;">
                <table id="file" class="table striped">
                  <thead>
                    ...
                    <tbody>
                    <?php
                        $query = mysqli_query($sambungan, "SELECT * FROM keluhan WHERE status_keluhan='Belum ditanggapi'")
                        ...
                        <tr>
                          ...
                          <td style= "color:#fff; "><?php echo mb_strimwidth($data['deskripsi_keluhan'],0,30,"...."); ?></td>
                          <td style="color:#fff;"><?php echo $data['tanggal']; ?></td>
                          <td style="color:#fff;"><p style="color:#d41872;"><?php echo$data['status_keluhan']; ?></p></td>
                          <td><?php echo '<a href="kirim-tanggapan.php?id_keluhan='.$data['id_keluhan'].'&pesan='.$data['id_keluhan'].'" class="btn btn-warning">Tanggapi</a>';?></td>
                        </tr><?php
                        }?>
                  </tbody>
                </table>
